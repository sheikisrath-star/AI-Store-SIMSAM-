...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    description: 'VerdaCapital provides corporate strategists and impact investors with the complete playbook for generating sustainable passive income through green technology ventures. Covers carbon credit monetization, ESG-linked SaaS models, renewable energy licensing, and green bond structuring.',
    price: 497,
    originalPrice: 997,
  ...
  },
  {
    ...
    description: 'VerdaDesign delivers a comprehensive library of professional design assets purpose-built for green technology companies and sustainability-driven enterprises. Includes corporate identity templates, ESG report layouts, sustainability campaign graphics, green certification badge systems, and investor presentation decks.',
    price: 247,
    originalPrice: 497,
    category: 'Eco-Design',
  ...
  },
  {
    ...
    description: 'VerdaChain is the definitive operational framework for enterprises seeking full supply chain carbon transparency. Provides structured methodologies for Scope 3 emission mapping, supplier carbon auditing, logistics decarbonization modeling, and circular economy transition planning.',
    price: 597,
    originalPrice: 1197,
  ...
  },
  {
    ...
    description: 'VerdaReport eliminates the manual burden of ESG reporting by providing AI-powered automation frameworks for all major disclosure standards. Generate CSRD-compliant reports, CDP submissions, GRI indexes, and TCFD disclosures at a fraction of the traditional cost and time.',
    price: 447,
    originalPrice: 897,
  ...
  },
  {
    ...
    description: 'VerdaCommerce is the comprehensive enterprise playbook for building and scaling a profitable eco-commerce SaaS business. Covers green product strategy, sustainable supply chain integration, carbon-neutral shipping frameworks, and global green market entry strategies.',
    price: 597,
    originalPrice: 1197,
  ...
  },
  {
    ...
    description: 'VerdaReach delivers the complete B2B digital marketing system for green technology companies seeking to acquire enterprise clients globally. Covers sustainability SEO strategy, LinkedIn thought leadership systems, green content marketing frameworks, and Account-Based Marketing playbooks.',
    price: 347,
    originalPrice: 697,
  ...
  },
  {
    ...
    features: [
      ...
      'Carbon credit tokenization (REC and carbon NFT) frameworks',
  ...
  },
  {
    ...
    description: 'VerdaTalent equips HR directors and talent acquisition teams with specialized tools for building high-performance sustainability and green technology teams. Includes ATS-optimized CV templates for 20+ green-tech roles, competency-based interview frameworks, and DEI-inclusive hiring guides.',
    price: 147,
    originalPrice: 297,
    category: 'Green HR',
  ...
  },
  {
    ...
    description: 'VerdaLaunch is the definitive accelerator program for entrepreneurs building sustainable technology micro-businesses. Covers climate-tech product ideation, MVP development frameworks, enterprise sales strategies, green startup funding pathways, and impact measurement systems.',
    price: 397,
    originalPrice: 797,
